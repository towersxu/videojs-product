...
},{"for-each":3,"trim":59}],58:[function(_dereq_,module,exports){
...
},{"global/window":8,"is-function":9,"once":56,"parse-headers":57,"xtend":62}],62:[function(_dereq_,module,exports){
...
},{"./clickable-component.js":65,"./component":67,"./utils/events.js":149,"./utils/fn.js":150,"./utils/log.js":153,"global/document":7,"object.assign":53}],65:[function(_dereq_,module,exports){
/**
 * @file button.js
 */
'use strict';
...
},{"./component":67,"./utils/dom.js":148,"./utils/events.js":149,"./utils/fn.js":150,"./utils/log.js":153,"global/document":7,"object.assign":53}],66:[function(_dereq_,module,exports){
'use strict';
...
},{"./utils/dom.js":148,"./utils/events.js":149,"./utils/fn.js":150,"./utils/guid.js":152,"./utils/log.js":153,"./utils/merge-options.js":154,"./utils/to-title-case.js":157,"global/window":8,"object.assign":53}],68:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/fn.js":150,"../track-button.js":103,"./audio-track-menu-item.js":69}],69:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu-item.js":115,"../../utils/fn.js":150}],70:[function(_dereq_,module,exports){
/**
 * @file control-bar.js
 */
'use strict';
...
var _subtitleToggleJs = _dereq_('./subtitle-toggle.js');

var _subtitleToggleJs2 = _interopRequireDefault(_subtitleToggleJs);
...
var _timeControlsCustomTimeDisplayJs = _dereq_('./time-controls/custom-time-display.js');

var _timeControlsCustomTimeDisplayJs2 = _interopRequireDefault(_timeControlsCustomTimeDisplayJs);

var _liveDisplayJs = _dereq_('./live-display.js');

var _liveDisplayJs2 = _interopRequireDefault(_liveDisplayJs);

var _playResolutionsJs = _dereq_('./play-resolutions.js');

var _playResolutionsJs2 = _interopRequireDefault(_playResolutionsJs);

var _playerRatioJs = _dereq_('./player-ratio.js');

var _playerRatioJs2 = _interopRequireDefault(_playerRatioJs);
...
var _logoTextJs = _dereq_('./logo-text.js');

var _logoTextJs2 = _interopRequireDefault(_logoTextJs);
...
ControlBar.prototype.options_ = {
  ...
  children: ['playToggle', 'CustomTimeDisplay', 'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'PlayResolutions', 'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'descriptionsButton', 'subtitlesButton', 'captionsButton', 'volumeMenuButton',
  // 'PlayerRatio',
...
},{"../component.js":67,"./audio-track-controls/audio-track-button.js":68,"./fullscreen-toggle.js":71,"./live-display.js":72,"./logo-text.js":73,"./mute-toggle.js":74,"./play-resolutions.js":75,"./play-toggle.js":76,"./playback-rate-menu/playback-rate-menu-button.js":77,"./player-ratio.js":79,"./progress-control/progress-control.js":83,"./spacer-controls/custom-control-spacer.js":86,"./subtitle-toggle.js":88,"./text-track-controls/captions-button.js":90,"./text-track-controls/chapters-button.js":91,"./text-track-controls/descriptions-button.js":93,"./text-track-controls/subtitles-button.js":95,"./time-controls/current-time-display.js":98,"./time-controls/custom-time-display.js":99,"./time-controls/duration-display.js":100,"./time-controls/remaining-time-display.js":101,"./time-controls/time-divider.js":102,"./volume-control/volume-control.js":105,"./volume-menu-button.js":107}],71:[function(_dereq_,module,exports){
/**
...
},{"../component":67,"../utils/dom.js":148}],73:[function(_dereq_,module,exports){
/**
...
var LogoText = (function (_Button) {
  _inherits(LogoText, _Button);

  function LogoText(player, options) {
    var _arguments = arguments,
        _this = this;

    _classCallCheck(this, LogoText);
    ...
    this.on('click', function () {
      if (typeof _arguments[1].click === 'function') {
        _arguments[1].click.call(_this);
      }
    });
  }
  ...
  LogoText.prototype.buildCSSClass = function buildCSSClass() {
    return 'vjs-play-control vjs-logo-control ' + _Button.prototype.buildCSSClass.call(this);
  };
  ...
  LogoText.prototype.handlePlay = function handlePlay() {
  ...
  LogoText.prototype.handlePause = function handlePause() {
...
_componentJs2['default'].registerComponent('LogoText', LogoText);
exports['default'] = LogoText;
module.exports = exports['default'];

},{"../button.js":64,"../component.js":67}],74:[function(_dereq_,module,exports){
/**
 * @file mute-toggle.js
 */
'use strict';
...
},{"../button":64,"../component":67,"../utils/dom.js":148}],75:[function(_dereq_,module,exports){
/**
...
var PlayResolutions = (function (_Component) {
  _inherits(PlayResolutions, _Component);

  function PlayResolutions(player, options) {
    var _arguments = arguments,
        _this = this;

    _classCallCheck(this, PlayResolutions);

    _Component.call(this, player, options);
    this.updateShowing();
    this.on(this.player(), 'durationchange', this.updateShowing);
    this.on(this.player(), 'ready', function () {
      if (_arguments && _arguments[1]) {
        var videos = _arguments[1].videos || [];
        var idx = _arguments[1].idx || 0;
        ...
        html += '</div>';
        var domEl = _this.el();
        _this.contentEl2_ = Dom.createEl('div', {
          className: 'vjs-gaia-resolution',
          innerHTML: html
        });
        if (videos.length === 1) {
          _this.contentEl2_.style.display = 'none';
          domEl.style.cursor = 'default';
        } else {
          domEl.appendChild(_this.contentEl2_);
        }
        _this.contentEl_.innerHTML = videos[idx].name;
        ...
        if (!videos[idx] || !videos[idx].src || videos[idx].src === 'TRANSCODING') {
          ...
          player.error_ = new _mediaErrorJs2['default'](message);
    ...
    this.on('click', function (e) {
      ...
      if (el && player) {
        ...
        player.play();
        _this.contentEl_.innerHTML = name;
      }
    });
  }
  ...
  PlayResolutions.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
      className: 'vjs-live-control vjs-control'
    });
  ...
  PlayResolutions.prototype.updateShowing = function updateShowing() {
    //if (this.player().duration() === Infinity) {
    this.show();
    //} else {
    //  this.hide();
  ...
  return PlayResolutions;
})(_component2['default']);

_component2['default'].registerComponent('PlayResolutions', PlayResolutions);
exports['default'] = PlayResolutions;
module.exports = exports['default'];

},{"../component":67,"../media-error.js":113,"../utils/dom.js":148}],76:[function(_dereq_,module,exports){
/**
 * @file play-toggle.js
 */
'use strict';
...
},{"../button.js":64,"../component.js":67}],77:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu-button.js":114,"../../menu/menu.js":116,"../../utils/dom.js":148,"./playback-rate-menu-item.js":78}],78:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu-item.js":115}],79:[function(_dereq_,module,exports){
/**
 * Created by taox on 16-2-14.
 */
'use strict';
...
var PlayerRatio = (function (_Component) {
  _inherits(PlayerRatio, _Component);

  function PlayerRatio(player, options) {
    var _arguments = arguments,
        _this = this;

    _classCallCheck(this, PlayerRatio);

    _Component.call(this, player, options);

    this.updateShowing();
    this.on(this.player(), 'durationchange', this.updateShowing);
    this.on(this.player(), 'ready', function (object) {
      if (_arguments && _arguments[1]) {
        var ratios = _arguments[1].ratios;
        console.log(ratios);
  ...
  PlayerRatio.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
  ...
  PlayerRatio.prototype.updateShowing = function updateShowing() {
    //if (this.player().duration() === Infinity) {
    this.show();
    //} else {
    //  this.hide();
...
_component2['default'].registerComponent('PlayerRatio', PlayerRatio);
exports['default'] = PlayerRatio;
module.exports = exports['default'];

},{"../component":67,"../utils/dom.js":148}],80:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/dom.js":148}],81:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/fn.js":150,"../../utils/format-time.js":151,"global/window":8,"lodash-compat/function/throttle":13}],82:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/fn.js":150,"../../utils/format-time.js":151}],83:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./mouse-time-display.js":81,"./seek-bar.js":84}],84:[function(_dereq_,module,exports){
/**
 * @file seek-bar.js
 */
'use strict';
...
},{"../../component.js":67,"../../slider/slider.js":124,"../../utils/fn.js":150,"../../utils/format-time.js":151,"./load-progress-bar.js":80,"./play-progress-bar.js":82,"./tooltip-progress-bar.js":85,"global/window":8,"object.assign":53}],85:[function(_dereq_,module,exports){
/**
 * @file play-progress-bar.js
 */
'use strict';
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/fn.js":150,"../../utils/format-time.js":151}],86:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./spacer.js":87}],87:[function(_dereq_,module,exports){
/**
 * @file spacer.js
 */
'use strict';
...
},{"../../component.js":67}],88:[function(_dereq_,module,exports){
/**
 * @file subtitle-toggle.js
 */
'use strict';
...
var SubtitleToggle = (function (_Button) {
  _inherits(SubtitleToggle, _Button);

  function SubtitleToggle(player, options) {
    _classCallCheck(this, SubtitleToggle);
  ...
  SubtitleToggle.prototype.buildCSSClass = function buildCSSClass() {
    return 'vjs-play-control vjs-subtitle-control ' + _Button.prototype.buildCSSClass.call(this);
  };
  ...
  SubtitleToggle.prototype.handleClick = function handleClick() {
    console.log('click');
  ...
  SubtitleToggle.prototype.handlePlay = function handlePlay() {
    this.removeClass('vjs-paused');
    this.addClass('vjs-playing');
    this.controlText('Pause'); // change the button text to "Pause"
  };
  ...
  SubtitleToggle.prototype.handlePause = function handlePause() {
    this.removeClass('vjs-playing');
    this.addClass('vjs-paused');
    this.controlText('Play'); // change the button text to "Play"
  };
...
SubtitleToggle.prototype.controlText_ = 'Play';

_componentJs2['default'].registerComponent('SubtitleToggle', SubtitleToggle);
exports['default'] = SubtitleToggle;
module.exports = exports['default'];

},{"../button.js":64,"../component.js":67}],89:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./text-track-menu-item.js":97}],90:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./caption-settings-menu-item.js":89,"./text-track-button.js":96}],91:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu.js":116,"../../utils/dom.js":148,"../../utils/fn.js":150,"../../utils/to-title-case.js":157,"./chapters-track-menu-item.js":92,"./text-track-button.js":96,"./text-track-menu-item.js":97,"global/window":8}],92:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu-item.js":115,"../../utils/fn.js":150}],93:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/fn.js":150,"./text-track-button.js":96}],94:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./text-track-menu-item.js":97}],95:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./text-track-button.js":96}],96:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/fn.js":150,"../track-button.js":103,"./off-text-track-menu-item.js":94,"./text-track-menu-item.js":97}],97:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../menu/menu-item.js":115,"../../utils/fn.js":150,"global/document":7,"global/window":8}],98:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/format-time.js":151}],99:[function(_dereq_,module,exports){
/**
 * Created by taox on 16-2-14.
 */
/**
...
var CustomTimeDisplay = (function (_Component) {
  _inherits(CustomTimeDisplay, _Component);

  function CustomTimeDisplay(player, options) {
    _classCallCheck(this, CustomTimeDisplay);
  ...
  CustomTimeDisplay.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
  ...
  CustomTimeDisplay.prototype.updateContent = function updateContent() {
    if (this.player_.duration()) {
      var localizedText = this.localize('Remaining Time');
      //const formattedTime = formatTime(this.player_.remainingTime());
      //console.log(this.player_.remainingTime());
      var time = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime();
      var formattedTime = _utilsFormatTimeJs2['default'](time, this.player_.duration());
      var formattedTime1 = _utilsFormatTimeJs2['default'](this.player_.duration());
  ...
  return CustomTimeDisplay;
})(_componentJs2['default']);

_componentJs2['default'].registerComponent('CustomTimeDisplay', CustomTimeDisplay);
exports['default'] = CustomTimeDisplay;
module.exports = exports['default'];

},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/format-time.js":151}],100:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/format-time.js":151}],101:[function(_dereq_,module,exports){
/**
 * @file remaining-time-display.js
 */
'use strict';
...
},{"../../component.js":67,"../../utils/dom.js":148,"../../utils/format-time.js":151}],102:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67}],103:[function(_dereq_,module,exports){
/**
...
},{"../component.js":67,"../menu/menu-button.js":114,"../utils/fn.js":150}],104:[function(_dereq_,module,exports){
/**
 * @file volume-bar.js
 */
'use strict';
...
},{"../../component.js":67,"../../slider/slider.js":124,"../../utils/fn.js":150,"./volume-level.js":106}],105:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67,"./volume-bar.js":104}],106:[function(_dereq_,module,exports){
/**
...
},{"../../component.js":67}],107:[function(_dereq_,module,exports){
/**
...
},{"../component.js":67,"../popup/popup-button.js":120,"../popup/popup.js":121,"../utils/fn.js":150,"./mute-toggle.js":74,"./volume-control/volume-bar.js":104}],108:[function(_dereq_,module,exports){
/**
...
},{"./component":67,"./modal-dialog":117,"./utils/dom":148,"./utils/merge-options":154}],109:[function(_dereq_,module,exports){
/**
...
},{"./utils/events.js":149}],110:[function(_dereq_,module,exports){
'use strict';
...
},{"./utils/log":153}],111:[function(_dereq_,module,exports){
/**
...
},{"global/document":7}],112:[function(_dereq_,module,exports){
/**
...
},{"./component":67}],113:[function(_dereq_,module,exports){
/**
 * @file media-error.js
 */
'use strict';
...
},{"object.assign":53}],114:[function(_dereq_,module,exports){
/**
 * @file menu-button.js
 */
'use strict';
...
},{"../clickable-component.js":65,"../component.js":67,"../utils/dom.js":148,"../utils/fn.js":150,"../utils/to-title-case.js":157,"./menu.js":116}],115:[function(_dereq_,module,exports){
/**
 * @file menu-item.js
 */
'use strict';
...
},{"../clickable-component.js":65,"../component.js":67,"object.assign":53}],116:[function(_dereq_,module,exports){
/**
 * @file menu.js
 */
'use strict';
...
},{"../component.js":67,"../utils/dom.js":148,"../utils/events.js":149,"../utils/fn.js":150}],117:[function(_dereq_,module,exports){
/**
...
},{"./close-button":66,"./component":67,"./utils/dom":148,"./utils/fn":150,"./utils/log":153}],118:[function(_dereq_,module,exports){
/**
 * @file player.js
 */
...
Player.prototype.options_ = {
  ...
  children: ['mediaLoader', 'posterImage', 'textTrackDisplay', 'loadingSpinner',
  //'bigPlayButton',
...
},{"./big-play-button.js":63,"./component.js":67,"./control-bar/control-bar.js":70,"./error-display.js":108,"./fullscreen-api.js":111,"./loading-spinner.js":112,"./media-error.js":113,"./modal-dialog":117,"./poster-image.js":122,"./tech/html5.js":127,"./tech/loader.js":128,"./tech/tech.js":129,"./tracks/audio-track-list.js":130,"./tracks/text-track-display.js":135,"./tracks/text-track-list-converter.js":136,"./tracks/text-track-settings.js":138,"./tracks/video-track-list.js":143,"./utils/browser.js":145,"./utils/buffer.js":146,"./utils/dom.js":148,"./utils/events.js":149,"./utils/fn.js":150,"./utils/guid.js":152,"./utils/log.js":153,"./utils/merge-options.js":154,"./utils/stylesheet.js":155,"./utils/time-ranges.js":156,"./utils/to-title-case.js":157,"global/document":7,"global/window":8,"object.assign":53,"safe-json-parse/tuple":58}],119:[function(_dereq_,module,exports){
/**
 * @file plugins.js
 */
'use strict';
...
},{"./player.js":118}],120:[function(_dereq_,module,exports){
/**
...
},{"../clickable-component.js":65,"../component.js":67,"../utils/dom.js":148,"../utils/fn.js":150,"../utils/to-title-case.js":157,"./popup.js":121}],121:[function(_dereq_,module,exports){
/**
 * @file popup.js
 */
'use strict';
...
},{"../component.js":67,"../utils/dom.js":148,"../utils/events.js":149,"../utils/fn.js":150}],122:[function(_dereq_,module,exports){
/**
...
},{"./clickable-component.js":65,"./component.js":67,"./utils/browser.js":145,"./utils/dom.js":148,"./utils/fn.js":150}],123:[function(_dereq_,module,exports){
/**
 * @file setup.js
 *
...
},{"./utils/events.js":149,"global/document":7,"global/window":8}],124:[function(_dereq_,module,exports){
/**
 * @file slider.js
 */
'use strict';
...
},{"../component.js":67,"../utils/dom.js":148,"object.assign":53}],125:[function(_dereq_,module,exports){
/**
 * @file flash-rtmp.js
 */
'use strict';
...
},{"../component":67,"../utils/dom.js":148,"../utils/time-ranges.js":156,"../utils/url.js":158,"./flash-rtmp":125,"./tech":129,"global/window":8,"object.assign":53}],127:[function(_dereq_,module,exports){
/**
 * @file html5.js
...
},{"../../../src/js/tracks/text-track.js":139,"../component":67,"../utils/browser.js":145,"../utils/dom.js":148,"../utils/fn.js":150,"../utils/log.js":153,"../utils/merge-options.js":154,"../utils/to-title-case.js":157,"../utils/url.js":158,"./tech.js":129,"global/document":7,"global/window":8,"object.assign":53,"tsml":60}],128:[function(_dereq_,module,exports){
/**
 * @file loader.js
 */
'use strict';
...
},{"../component.js":67,"../utils/to-title-case.js":157,"./tech.js":129,"global/window":8}],129:[function(_dereq_,module,exports){
/**
 * @file tech.js
  ...
  Tech.prototype.emulateTextTracks = function emulateTextTracks() {
    ...
    if (!_globalWindow2['default']['WebVTT'] && this.el().parentNode != null) {
      (function () {
        ...
        script.src = _this3.options_['vtt.js'] || '../node_modules/videojs-vtt.js/dist/vtt.js';
...
},{"../component":67,"../media-error.js":113,"../tracks/audio-track":131,"../tracks/audio-track-list":130,"../tracks/html-track-element":133,"../tracks/html-track-element-list":132,"../tracks/text-track":139,"../tracks/text-track-list":137,"../tracks/video-track":144,"../tracks/video-track-list":143,"../utils/buffer.js":146,"../utils/fn.js":150,"../utils/log.js":153,"../utils/merge-options.js":154,"../utils/time-ranges.js":156,"global/document":7,"global/window":8}],130:[function(_dereq_,module,exports){
/**
...
},{"../utils/browser.js":145,"./track-list":141,"global/document":7}],131:[function(_dereq_,module,exports){
'use strict';
...
},{"../utils/browser.js":145,"../utils/merge-options":154,"./track":142,"./track-enums":140}],132:[function(_dereq_,module,exports){
/**
...
},{"../utils/browser.js":145,"global/document":7}],133:[function(_dereq_,module,exports){
/**
...
},{"../event-target":109,"../tracks/text-track":139,"../utils/browser.js":145,"global/document":7}],134:[function(_dereq_,module,exports){
/**
...
},{"../utils/browser.js":145,"global/document":7}],135:[function(_dereq_,module,exports){
/**
...
},{"../component":67,"../menu/menu-button.js":114,"../menu/menu-item.js":115,"../menu/menu.js":116,"../utils/fn.js":150,"global/document":7,"global/window":8}],136:[function(_dereq_,module,exports){
/**
...
},{"../utils/browser.js":145,"../utils/fn.js":150,"./track-list":141,"global/document":7}],138:[function(_dereq_,module,exports){
/**
...
},{"../component":67,"../utils/events.js":149,"../utils/fn.js":150,"../utils/log.js":153,"global/window":8,"safe-json-parse/tuple":58}],139:[function(_dereq_,module,exports){
/**
 * @file text-track.js
 */
'use strict';
...
},{"../utils/browser.js":145,"../utils/fn.js":150,"../utils/log.js":153,"../utils/merge-options":154,"../utils/url.js":158,"./text-track-cue-list":134,"./track-enums":140,"./track.js":142,"global/document":7,"global/window":8,"xhr":61}],140:[function(_dereq_,module,exports){
/**
 * @file track-kinds.js
 */
...
},{"../event-target":109,"../utils/browser.js":145,"../utils/fn.js":150,"global/document":7}],142:[function(_dereq_,module,exports){
/**
 * @file track.js
 */
'use strict';
...
},{"../event-target":109,"../utils/browser.js":145,"../utils/guid.js":152,"global/document":7}],143:[function(_dereq_,module,exports){
/**
...
},{"../utils/browser.js":145,"./track-list":141,"global/document":7}],144:[function(_dereq_,module,exports){
'use strict';
...
},{"../utils/browser.js":145,"../utils/merge-options":154,"./track":142,"./track-enums":140}],145:[function(_dereq_,module,exports){
/**
 * @file browser.js
 */
'use strict';
...
},{"global/document":7,"global/window":8}],146:[function(_dereq_,module,exports){
/**
 * @file buffer.js
 */
'use strict';
...
},{"./time-ranges.js":156}],147:[function(_dereq_,module,exports){
'use strict';
...
},{"./log.js":153}],148:[function(_dereq_,module,exports){
/**
 * @file dom.js
 */
'use strict';
...
},{"./guid.js":152,"./log.js":153,"global/document":7,"global/window":8,"tsml":60}],149:[function(_dereq_,module,exports){
/**
 * @file events.js
 *
...
},{"./dom.js":148,"./guid.js":152,"global/document":7,"global/window":8}],150:[function(_dereq_,module,exports){
/**
 * @file fn.js
 */
'use strict';
...
},{"./guid.js":152}],151:[function(_dereq_,module,exports){
/**
 * @file format-time.js
 *
...
},{"global/window":8}],154:[function(_dereq_,module,exports){
/**
...
},{"lodash-compat/object/merge":46}],155:[function(_dereq_,module,exports){
'use strict';
...
},{"global/document":7}],156:[function(_dereq_,module,exports){
'use strict';
...
},{"./log.js":153}],157:[function(_dereq_,module,exports){
/**
...
},{"global/document":7,"global/window":8}],159:[function(_dereq_,module,exports){
/**
 * @file video.js
 */
'use strict';
...
},{"../../src/js/utils/merge-options.js":154,"./component":67,"./event-target":109,"./extend.js":110,"./player":118,"./plugins.js":119,"./setup":123,"./tech/flash.js":126,"./tech/html5.js":127,"./tech/tech.js":129,"./tracks/audio-track.js":131,"./tracks/text-track.js":139,"./tracks/video-track.js":144,"./utils/browser.js":145,"./utils/create-deprecation-proxy.js":147,"./utils/dom.js":148,"./utils/events.js":149,"./utils/fn.js":150,"./utils/format-time.js":151,"./utils/log.js":153,"./utils/stylesheet.js":155,"./utils/time-ranges.js":156,"./utils/url.js":158,"global/document":7,"global/window":8,"lodash-compat/object/merge":46,"object.assign":53,"xhr":61}]},{},[159])(159)
});
